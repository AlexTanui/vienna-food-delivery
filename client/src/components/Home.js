...
const App = () => {
  ...
  useEffect(() => {
    // Simulate some asynchronous process (e.g., loading data or assets)
    setTimeout(() => {
      setContentLoaded(true);
    }, 30); // Adjust the time accordingly
  }, []);
  ...
  return (
    <><Helmet>
       ...
       <link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=Montserrat:300,400,500,600,700,900" />
      ...
      <div className="page">
                  ...
                  <div className="rd-navbar-panel">
                    ...
                    <div className="rd-navbar-brand">
                      ...
                      <a className="brand" href="index.html">
                        <img className="brand-logo-dark" src="images/logo-default-363x100.png" alt="" width="181" height="50" />
                        <img className="brand-logo-light" src="images/logo-inverse-363x100.png" alt="" width="181" height="50" />
                      </a>
                    </div>
                  </div>
                  <div className="rd-navbar-nav-wrap">
                    <ul className="rd-navbar-nav">
                      <li className="rd-nav-item">
                        <a className="rd-nav-link" href="#programs">Programs</a>
                      </li>
                      <li className="rd-nav-item">
                        <a className="rd-nav-link" href="#about">About</a>
                      </li>
                      <li className="rd-nav-item">
                        <a className="rd-nav-link" href="#clients">Clients</a>
                      </li>
                    </ul>
                  </div>
                </div>
              </div>
              <button className="rd-navbar-aside-open-toggle" data-custom-toggle="#rd-navbar-aside"></button>
              <div className="rd-navbar-aside" id="rd-navbar-aside">
                ...
                <form className="rd-form rd-mailform" data-form-output="form-output-global" data-form-type="contact" method="post" action="bat/rd-mailform.php">
                  <div class="row row-22">
                    ...
                    <div class="col-12">
                      <div class="form-wrap">
                        <input class="form-input" id="contact-email" type="email" name="email" data-constraints="@Email @Required"></input>
                        <label class="form-label" for="contact-email">E-mail</label>
                      </div>
                    </div>
                    <div class="col-12">
                      <div class="form-wrap">
                        <input class="form-input" id="contact-phone" type="text" name="phone" data-constraints="@Numeric"></input>
        ...
        {/* Swiper */}
        <section className="section swiper-container swiper-slider bg-primary" data-autoplay="3500" data-loop="false" data-simulate-touch="false" data-effect="circle-bg" data-speed="750">
        ...
        <section className="section novi-bg novi-bg-img section-sm bg-gray-100 pb-xl-0" id="about">
                 <div class="container">
          <div class="row row-50 flex-wrap-md-reverse flex-lg-wrap align-items-lg-center">
            ...
            <div class="col-xl-5 col-lg-6">
              <div class="box-custom-1">
                <h3>About us</h3>
                <h2>healthy food <br/>an be delicious</h2>
        ...
        {/* What we Offer */}
        <section className="section novi-bg novi-bg-img section-md-4 bg-primary">
          <div class="container">
        ...
        {/* How it Works */}
        <section className="section novi-bg novi-bg-img section-md-2 bg-default">
          <div class="container">
          <div class="text-center">
            <h3>how it works</h3>
        ...
        {/* Advantages */}
        <section className="section novi-bg novi-bg-img section-custom section-lg bg-primary">
         <div class="container">
        ...
        {/* Testimonials */}
        <section className="section novi-bg novi-bg-img section-md-3 bg-default" id="clients">
         <div class="container">
        ...
        <section>
          <a className="d-block" href="https://www.templatemonster.com/landing-page-template/plate-healthy-food-one-page-lean-html-landing-page-template-76237.html" target="_blank">
            <img className="img-responsive" src="images/banner-bottom-2050x310.jpg" alt="" width="2050" height="155" />
          </a>
        </section>
        <footer className="section footer-classic">
          <div className="container">
            ...
            <div class="col-xl-3 col-md-6">
              <a class="brand" href="index.html"><img class="brand-logo-dark" src="images/logo-default-363x100.png" alt="" width="181" height="50"/><img class="brand-logo-light" src="images/logo-inverse-363x100.png" alt="" width="181" height="50"/></a>
